...
const SYLLABUS_DATA = [
  ...
  },
  {
    ...
    "code": "tasks = [\"Write Python code\", \"Have coffee\", \"Learn React\", \"Review project\"]\n\nprint(\"--- Today's Tasks ---\")\nfor index, task in enumerate(tasks, start=1):\n    print(f\"{index}. {task}\")\n\n# Numbers from 1 to 5\nfor i in range(1, 6):\n    print(f\"Step: {i}\")",
    "codeLanguage": "python",
  ...
  },
  {
    ...
    "code": "user_profile = {\n    \"id\": 101,\n    \"name\": \"Alex\",\n    \"role\": \"Fullstack Developer\",\n    \"skills\": [\"Python\", \"Flask\", \"React\"],\n    \"is_active\": True\n}\n\n# Accessing values\nprint(f\"Name: {user_profile['name']}\")\nprint(f\"Primary Skill: {user_profile['skills'][0]}\")\n\n# Adding new data\nuser_profile[\"country\"] = \"India\"\nprint(user_profile)",
    "codeLanguage": "python",
  ...
  },
  {
    ...
    "code": "# app.py\nfrom flask import Flask\n\napp = Flask(__name__)\n\n@app.route(\"/\")\ndef home():\n    return \"<h1>Hello! This is my first Python web server!</h1>\"\n\n@app.route(\"/about\")\ndef about():\n    return \"<p>Learning Python + React Fullstack Development.</p>\"\n\nif __name__ == \"__main__\":\n    app.run(debug=True, port=5000)",
    "codeLanguage": "python",
  ...
  },
  {
    ...
    "code": "// Variables in JavaScript\nconst appName = \"React Learner\"; // Constant value\nlet currentDay = 15;             // Mutable value\n\n// Traditional function\nfunction sayHello(name) {\n  return \"Hello \" + name;\n}\n\n// Modern Arrow Function (Used heavily in React)\nconst sayHi = (name) => `Hello ${name}! Welcome!`;\n\nconsole.log(sayHi(\"Friend\"));",
